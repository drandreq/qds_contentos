# MASTER ARCHITECTURAL INSTRUCTION: CONTENTOS (V2)
...
Sprints must be delivered **one at a time**, each testing exactly one verifiable capability.
...
5. **Sprint 5 (Telegram Text):** Handle webhook text payloads, map to `.md` seeds.
6. **Sprint 6 (Telegram Voice):** Gemini transcription API integration.
